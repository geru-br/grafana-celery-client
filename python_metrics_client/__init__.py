...
def includeme(config):
    ...
    current_app.conf.metrics_user = config.registry.settings.get('metrics_client_type', 'root')
    current_app.conf.metrics_password = config.registry.settings.get('metrics_client_type', 'root')
